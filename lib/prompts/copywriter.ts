...
11. Длинные тире (—) используй умеренно. Они должны появляться только когда действительно усиливают мысль или ритм. Не злоупотребляй: если в коротком тексте тире встречается 3+ раз — это перебор. Где можно — заменяй на запятые, точки или двоеточия.
